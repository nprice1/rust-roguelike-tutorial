...
pub fn random_builder(
    ...
    let mut builder = BuilderChain::new(new_depth, width, height, "New Map", show_visualizer);
...
pub fn level_builder(
    ...
    match new_depth {
        1 => town_builder(new_depth, width, height, show_visualizer),
        2 => forest_builder(new_depth, width, height, show_visualizer),
        3 => limestone_cavern_builder(new_depth, width, height, show_visualizer),
        4 => limestone_deep_cavern_builder(new_depth, width, height, show_visualizer),
        5 => limestone_transition_builder(new_depth, width, height, show_visualizer),
        6 => dwarf_fort_builder(new_depth, width, height, show_visualizer),
        7 => mushroom_entrance(new_depth, width, height, show_visualizer),
        8 => mushroom_builder(new_depth, width, height, show_visualizer),
        9 => mushroom_exit(new_depth, width, height, show_visualizer),
        10 => dark_elf_city(new_depth, width, height, show_visualizer),
        11 => dark_elf_plaza(new_depth, width, height, show_visualizer),
        _ => random_builder(new_depth, width, height, show_visualizer),
    }
}
